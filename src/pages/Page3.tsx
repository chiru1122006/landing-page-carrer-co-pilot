...
const cardData: BentoCardProps[] = [
  ...
  },
  {
    ...
    description: 'Users can\'t clearly see growth, readiness level, or next actionable steps.',
    label: 'Problem 6'
  }
];
...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section w-full select-none relative mx-auto container px-4 md:px-8 py-10"
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive">
          {cardData.slice(0, 5).map((card, index) => {
            const baseClassName = `card group relative flex size-full flex-col justify-between overflow-hidden rounded-xl bg-black/40 border border-white/10 shadow-[0_-20px_80px_-20px_#ffffff1f_inset] transform-gpu transition-all duration-300 p-6 ${
            ...
            if (enableStars) {
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 z-[1] bg-gradient-to-t from-black/80 via-black/20 to-transparent pointer-events-none"></div>
                  ...
                  <div className="card__content flex flex-col relative text-white z-10">
                    ...
                    <p
                      className={`card__description text-sm md:text-base leading-6 ${textAutoHide ? 'text-clamp-2' : ''}`}
                    >
                      {card.description}
                    </p>
                  </div>
            ...
            return (
              ...
              >
                ...
                <div className="card__content flex flex-col relative text-white z-10">
                  ...
                  <p className={`card__description text-sm md:text-base leading-6 ${textAutoHide ? 'text-clamp-2' : ''}`}>
                    {card.description}
                  </p>
                </div>
              </div>
  ...
  return (
    <div className="relative w-full min-h-screen bg-black py-20">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Left fade */}
        <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-white/5 to-transparent"></div>
        {/* Right fade */}
        <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-white/5 to-transparent"></div>
      </div>
      ...
      <div className="text-center mb-16 relative z-10">
        ...
        <p className="text-gray-400 text-lg max-w-2xl mx-auto px-6">
          Understanding the challenges in career development today
        </p>
      </div>

      {/* MagicBento Component - Bigger Container */}
